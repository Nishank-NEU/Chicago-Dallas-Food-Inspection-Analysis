 ...
 *
 * Date Created : Monday, April 17, 2023 23:36:25
...
/* 
 * TABLE: dim_License_SCD 
 */

CREATE TABLE dim_License_SCD(
    ...
    License_Term_StartDate         char(10)        NULL,
    License_Term_ExpirationDate    char(10)        NULL,
    License_Status_ChangeDate      char(10)        NULL,
...
IF OBJECT_ID('dim_License_SCD') IS NOT NULL
    PRINT '<<< CREATED TABLE dim_License_SCD >>>'
ELSE
    PRINT '<<< FAILED CREATING TABLE dim_License_SCD >>>'
go
...
/* 
 * TABLE: Dim_Violations_SCD 
 */

CREATE TABLE Dim_Violations_SCD(
...
IF OBJECT_ID('Dim_Violations_SCD') IS NOT NULL
    PRINT '<<< CREATED TABLE Dim_Violations_SCD >>>'
ELSE
    PRINT '<<< FAILED CREATING TABLE Dim_Violations_SCD >>>'
go
...
ALTER TABLE FCT_Inspections ADD CONSTRAINT Refdim_License_SCD14 
    FOREIGN KEY (License_SK)
    REFERENCES dim_License_SCD(License_SK)
go
...
ALTER TABLE FCT_Violations ADD CONSTRAINT RefDim_Violations_SCD19 
    FOREIGN KEY (Volations_SCD_SK)
    REFERENCES Dim_Violations_SCD(Volations_SCD_SK)
go
